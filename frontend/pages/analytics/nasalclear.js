...
export default function Nasalclear(){
    return (
      <main role="main" className="h-full inline w-full sm:w-3/4 md:w-4/5">
      <div className="flex flex-row">
        <h1 className="m-8 ml-12 text-grey-dark text-3xl font-bold">Nasalclear Analytics</h1>
      ...
      <div className="ml-10 mr-10 flex flex-wrap gap-8 mb-10">
        <div className="flex-auto max-w-full bg-white shadow-lg rounded-lg"><TopDoctorNewPerscriptions product="Nasalclear"/></div>
